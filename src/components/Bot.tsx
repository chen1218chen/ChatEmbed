  ...
  return (
    <>
      ...
      >
        ...
        <Badge badgeBackgroundColor={props.badgeBackgroundColor} poweredByTextColor={props.poweredByTextColor} poweredByText={props.poweredByText} botContainer={botContainer} />
