...
const defaultAdditionalMessage = '4';
...
export const Bot = (props: BotProps & { class?: string }) => {
  ...
  const handleSubmit = async (value: string) => {
    ...
    const additionalMessage = props.additionalMessage ?? defaultAdditionalMessage;
    const historyList = messageList.slice(0 - parseInt(additionalMessage));
    // console.log('messageList', historyList);
